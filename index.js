		...
		startGame: function() {
	  	...
	  	keepPromptingUser : function(){
	    	...
	    	inquirer.prompt([{
	        	...
	        	// otherwise reprompt user if letter was already
	        	} else{
	            	console.log("You've already guessed this letter. You should really work on your short term memory. Pick another letter!");
	            	here.keepPromptingUser();
	          	}
